        ...
        <div className={classes.root}>
          ...
          >
            ...
            <List>
              ...
              <ListItem button component={Link} to="/advancedgridlist">
                <ListItemIcon>
                  <StarIcon />
                </ListItemIcon>
                <ListItemText primary="Advanced GridList" />
              </ListItem>
              ...
              <ListItem button component={Link} to="/advancedtables">
                <ListItemIcon>
                  <DraftsIcon />
                </ListItemIcon>
                <ListItemText primary="Advanced Tables" />
              </ListItem>
          ...
          <main className={classes.content}>
            ...
            <Route path="/advancedgridlist" component={AdvancedGridList} />
